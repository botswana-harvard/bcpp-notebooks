...
13. <a href="#user-content-death-report-tmg1-6">Death Report Tmg1</a>
...
**18.0.** If no, how many days of treatment missed this month?
* db_table: ambition_subject_patienthistory
* column: days_missed
* type: IntegerField
---
...
**41.0.** Previous opportunistic infection other than TB?
* db_table: ambition_subject_patienthistory
* column: previous_oi
* type: CharField
* length: 5
...
**10.0.** How much time did a caring family member take off work to accompany you to the hospital?
...
**17.0.** Did you go to elementary school?
* db_table: ambition_subject_healtheconomicsquestionnaire
...
**24.0.** How many years of education did head of houesehold complete?
* db_table: ambition_subject_healtheconomicsquestionnaire
...
**31.0.** If YES, for how many years?
* db_table: ambition_subject_healtheconomicsquestionnaire
...
**12.0.** If results are abnormal, what is the reason?
* db_table: ambition_subject_radiology
...
**3.0.** Could this occurrence have an impact on safety of the participant?
* db_table: ambition_subject_protocoldeviationviolation
...
**15.0.** If yes, Specify length of course:
* db_table: ambition_subject_recurrencesymptom
...
**Section: Induction phase Study medication**

**6.0.** Amphotericin B start date: 
* db_table: ambition_subject_week2
...
**14.0.** Other drugs/interventions given during first 14 days
* db_table: ambition_subject_week2
...
**16.0.** Blood transfusion received?
* db_table: ambition_subject_week2
...
**27.0.** Other significant diagnosis since enrollment?
* db_table: ambition_subject_week2
...
**10.0.** Fluconazole dose (Day prior to visit)
* db_table: ambition_subject_week4
...
**11.0.** Rifampicin started since last visit?
* db_table: ambition_subject_week4
...
**13.0.** Other significant diagnosis since last visit?
* db_table: ambition_subject_week4
* column: other_significant_dx
* type: CharField
* length: 5
...
**10.0.** Recurrence of Symptoms?
* db_table: ambition_subject_prnmodel
* column: recurrence_symptom
* type: CharField
* length: 5
* responses:
  - `Yes`: *Yes* 
...
**13.0.** Over that last 4 weeks, how much have you spent on activities relating to your health?
* db_table: ambition_subject_followup
* column: personal_he_spend
* type: DecimalField
---

**14.0.** Over that last 4 weeks, how much has someone else spent on activities relating to your health?
* db_table: ambition_subject_followup
* column: proxy_he_spend
* type: DecimalField
---

**15.0.** How much in total has been spent on your healthcare in the last 4 weeks?
* db_table: ambition_subject_followup
* column: he_spend_last_4weeks
* type: DecimalField
---

**16.0.** Have you received any treatment or care for your present condition, before coming to the hospital?
* db_table: ambition_subject_followup
* column: care_before_hospital
* type: CharField
* length: 5
...
**17.0.** If Yes, where did you receive treatment or care?
* db_table: ambition_subject_followup
* column: location_care
* type: CharField
* length: 35
* responses:
  - `N/A`: *Not Applicable* 
...
* db_table: ambition_subject_followup
* column: location_care_other
* type: CharField
* length: 35
* responses: *free text*
---

**18.0.** Which form of transport did you take to reach there?
* db_table: ambition_subject_followup
* column: transport_form
* type: CharField
* length: 20
* responses:
  - `bus`: *Bus* 
...
**19.0.** How much did you spend on the transport (each way)?
* db_table: ambition_subject_followup
...
&nbsp;&nbsp;&nbsp;&nbsp; *in hours:minutes*
* db_table: ambition_subject_followup
* column: transport_duration
* type: CharField
* length: 8
* responses: *free text*
---

**21.0.** Who provided treatment or care during that visit?
* db_table: ambition_subject_followup
...
* db_table: ambition_subject_followup
* column: care_provider_other
* type: CharField
* length: 25
* responses: *free text*
---

**22.0.** Did you pay for the treatment you received during that visit
* db_table: ambition_subject_followup
* column: paid_treatment
* type: CharField
* length: 15
* responses:
  - `Yes`: *Yes* 
...
**23.0.** How much did you pay for this visit?
* db_table: ambition_subject_followup
* column: paid_treatment_amount
* type: DecimalField
---

**24.0.** Did you buy other medication for relief?
* db_table: ambition_subject_followup
* column: medication_bought
* type: CharField
* length: 15
* responses:
  - `Yes`: *Yes* 
...
**25.0.** How much did you pay?
* db_table: ambition_subject_followup
* column: medication_payment
* type: DecimalField
---

**26.0.** Before this, did you go to another place for the treatment of the present situation?
* db_table: ambition_subject_followup
* column: other_place_visited
* type: CharField
* length: 15
* responses:
  - `Yes`: *Yes* 
...
**27.0.** How long have you been sick with your current condition?
...
**28.0.** What would you have been doing if you were not sick with your present condition
* db_table: ambition_subject_followup
* column: activities_missed
* type: CharField
* length: 25
...
**29.0.** How much time did you take off work?
...
**30.0.** How much time did a caring family member take off work to accompany you to the hospital?
...
**31.0.** Did you lose earnings as a result?
* db_table: ambition_subject_followup
* column: loss_of_earnings
* type: CharField
* length: 5
...
**32.0.** How much did you lose?
* db_table: ambition_subject_followup
* column: earnings_lost_amount
* type: DecimalField
---

**33.0.** Other significant diagnosis since last visit?
* db_table: ambition_subject_followup
* column: other_significant_dx
* type: CharField
* length: 5
...
**34.0.** Visual acuity Left Eye
* db_table: ambition_subject_followup
* column: visual_acuity_left_eye
* type: DecimalField
---

**35.0.** Visual acuity Right Eye
* db_table: ambition_subject_followup
* column: visual_acuity_right_eye
* type: DecimalField
---

**36.0.** Does the patient require help from anybody for everyday activities? 
...
**37.0.** Has the illness left the patient with any other problems?
* db_table: ambition_subject_followup
...
**1.0.** subject visit
* db_table: ambition_subject_studyterminationconclusion
* column: subject_visit
* type: OneToOneField
---

**2.0.** Date patient terminated on study:
* db_table: ambition_subject_studyterminationconclusion
* column: patient_terminated_date
* type: DateField
* format: YYYY-MM-DD
---

**3.0.** Date of last research follow up (if different):
* db_table: ambition_subject_studyterminationconclusion
* column: last_study_fu_date
* type: DateField
* format: YYYY-MM-DD
---

**4.0.** Was the patient discharged after initial admission?
* db_table: ambition_subject_studyterminationconclusion
* column: discharged_after_initial_admission
* type: CharField
* length: 6
* responses:
  - `Yes`: *Yes* 
...
**5.0.** Date of initial discharge
* db_table: ambition_subject_studyterminationconclusion
* column: initial_discharge_date
* type: DateField
* format: YYYY-MM-DD
---

**6.0.** Was the patient readmitted following initial discharge?
* db_table: ambition_subject_studyterminationconclusion
* column: readmission_after_initial_discharge
* type: CharField
* length: 7
* responses:
  - `Yes`: *Yes* 
...
**7.0.** Date of readmission
* db_table: ambition_subject_studyterminationconclusion
* column: readmission_date
* type: DateField
* format: YYYY-MM-DD
---
...
**9.0.** Reason for study termination
...
* responses:
  ...
  - `withdrawal_of_subject_consent`: *Withdrawal of Subject Consent for participation* 
  - `care_transferred_to_another_institution`: *Care transferred to another institution* 
...
**11.0.** Reason for withdrawing consent
* db_table: ambition_subject_studyterminationconclusion
* column: consent_withdrawal_reason
* type: CharField
* length: 75
* responses: *free text*
---

**12.0.** Is the patient willing to complete the 10 week FU visit only?
* db_table: ambition_subject_studyterminationconclusion
* column: willing_to_complete_10w
* type: CharField
* length: 12
* responses:
  - `Yes`: *Yes* 
...
**13.0.** Is the patient willing to complete the 10 week FU visit only at their new care centre?
* db_table: ambition_subject_studyterminationconclusion
* column: willing_to_complete_centre
* type: CharField
* length: 17
* responses:
  - `Yes`: *Yes* 
...
**14.0.**  Date the 10W FU due
* db_table: ambition_subject_studyterminationconclusion
* column: willing_to_complete_date
* type: DateField
* format: YYYY-MM-DD
---

**15.0.** Late protocol exclusion met?
* db_table: ambition_subject_studyterminationconclusion
* column: protocol_exclusion_criterion
* type: CharField
* length: 12
* responses:
  - `Yes`: *Yes* 
...
**16.0.** If included in error, narrative:
* db_table: ambition_subject_studyterminationconclusion
* column: included_in_error
* type: TextField
* length: 300
---

**17.0.** If included in error, date
* db_table: ambition_subject_studyterminationconclusion
* column: included_in_error_date
* type: DateField
* format: YYYY-MM-DD
---

**18.0.** Rifampicin started since week 4?
* db_table: ambition_subject_studyterminationconclusion
* column: rifampicin_started
* type: CharField
* length: 30
...
**19.0.** ART regimen started for naive patients (or regimen switched for those already on ARVs)
* db_table: ambition_subject_studyterminationconclusion
* column: first_line_regimen
* type: CharField
* length: 75
* responses:
  - `N/A`: *Not Applicable* 
...
* db_table: ambition_subject_studyterminationconclusion
* column: first_line_regimen_other
* type: CharField
* length: 100
* responses: *free text*
---

**20.0.** Second line arv regimen
* db_table: ambition_subject_studyterminationconclusion
* column: second_line_regimen
* type: CharField
* length: 50
* responses:
  - `N/A`: *Not Applicable* 
...
**20.1.** If Other, specify ...
* db_table: ambition_subject_studyterminationconclusion
* column: second_line_regimen_other
* type: CharField
* length: 35
* responses: *free text*
---

**21.0.** arvs started switch date
* db_table: ambition_subject_studyterminationconclusion
* column: arvs_started_switch_date
* type: DateField
* format: YYYY-MM-DD
---

**22.0.** If first line, on EFV or NVP and or DTG?
* db_table: ambition_subject_studyterminationconclusion
* column: first_line_env
* type: CharField
* length: 3
* responses:
  - `N/A`: *Not Applicable* 
...
**23.0.** Reason ARVs not started
* db_table: ambition_subject_studyterminationconclusion
* column: arvs_delay_reason
* type: CharField
* length: 75
* responses: *free text*
---
...
**3.0.** If dead, date and time of death
* db_table: ambition_subject_week16
* column: death_datetime
* type: DateTimeField
* format: YYYY-MM-DD HH:MM:SS.sss (tz=UTC)
...
**4.0.** Does the patient require help from anybody for everyday activities?
...
**5.0.** Has the illness left the patient with any other problems?
* db_table: ambition_subject_week16
